...
const Index = () => {
  return <div className="min-h-screen bg-gradient-to-b from-blue-500 via-blue-400 to-orange-200 overflow-hidden">
      {/* Auth Buttons */}
      ...
      <div className="container px-4 py-24 mx-auto text-center relative z-10">
        ...
        y: 0
          ...
          {/* Hero Text */}
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-tight">Your journal is closer than ever to your todos and calendar!</h1>
            ...
            <div className="bg-white/90 backdrop-blur-lg rounded-2xl p-8 shadow-2xl">
              <div className="flex items-center justify-between mb-6">
                <div className="flex space-x-2">
                  {["Mon", "Tue", "Wed", "Thu", "Fri"].map((day, i) => <div key={i} className="px-3 py-2 bg-white rounded-xl shadow-sm">
      ...
      repeat: Infinity,
      ease: "easeInOut"
    }} className="absolute top-40 right-[15%] w-32 h-32 rounded-3xl bg-gradient-to-br from-pink-200 to-pink-300 shadow-xl" style={{
